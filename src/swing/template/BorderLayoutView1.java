...
// 이벤트 처리를 담당하는 인터페이스가 필요해요. - ActionListener -> 인터페이스가 정의하고 있는 actionPerformed메소드를 재정의해야함
class BorderLayoutView1 implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		System.out.println("주소번지 @4321" +obj);
		String jbtnLabel = e.getActionCommand();
		System.out.println(jbtnLabel);//'북쪽'이라는 라벨을 찍는 출력
		if(jbtn_north == obj) {

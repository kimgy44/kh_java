...
public class Main_1 extends JFrame implements ActionListener {
	...
	public void initDisplay() {
		...
		// 입력 버튼이 눌러졌을 떄 누가? JVM이 감지하고 이벤트 처리 메소드를 호출해주는 역할
		// 아래 코드가 없으면 느낄 수가 없다. - 딱 한번만 호출되어야 한다.
		btnInsert.addActionListener(this);
		// this: who? Main_1, super: who? Frame
		// 내(나-Main_1) 안에서 add,s= setTitle, setSize, setVisible 메소드를 선언 및 구현한 적이 없다.
...
/* 36 - 37(인.화:디폴트[파라미터가 없는 생성자]생성자호출)-생성자 정의되지 않았다. -제공된다.(who? JVM-jdk11.0.10) - 28(hot spot)

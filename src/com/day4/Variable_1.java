...
public class Variable_1 {
	...
	int age = 20;//전역변수는 인스턴스화가 실행되고 나면 그 다음에 heap메모리 안에 클래스 안에 초기화가 됨
	// 사용자 정의 메소드 선언 - 피라미터는 없어도 합법, 있어도 합법
	void methodA() {
	...
	public static void main(String[] args) {// break point
		...
		// 아래코드에서 30이 출력됨
		System.out.println("after : "+v1.age); //30
	}// end of main - 북마크를 한다
}////// end of Variable_1

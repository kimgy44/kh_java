...
public class StringTest1 {
	...
	public static void main(String[] args) {
		...
		// 자바에서 제공되는 클래스 입니다.
		// 따라서 개발자의 의도와 상관 없이 자기가(JVM) 생각하고 있는
		// 값을 출력하는 경우도 있습니다. 그래서 결과가 다르게 출력됨
		//일관성이 없이 말이 바뀐다.
		JButton jbtn = new JButton("북쪽");
		// 이것은 자바가상머신에서 제공되는 클래스가 아님
		System.out.println("StringTest1 ===> "+st1);//@2113afc
		System.out.println("StringTest1 ===> "+st1.toString());//@2113afc
		// 참조형 변수 이다.
		String s = new String("좋은 아침입니다.");
		String s1 = new String("좋은 아침입니다.");
		System.out.println("StringTest1 ===> "+s);//@4532aef
		// = 대입연산자

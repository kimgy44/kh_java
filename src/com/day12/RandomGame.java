...
public class RandomGame {
	// static이 있는 메소드에 대해서는 인스턴화 없이
	// 클래스타입. 메소드명으로 호출이 가능합
	public static void gameStart() {
		// 임의의 숫자를 채번하는 메소드를 제공하는 클래스 임 - 0.0~1.0
		Random r = new Random();
        // 게임이 시작되기 전에 0부터 9사이의 임의의 수를 채번하기
		// 사용자가 값을 입력하는 것보다 먼저채번해야 된다.
        ...
        String str = null;
        // str = scan.next();
        // 사용자가 입력한 값이 null이 아니면 계속 돌아라 - 반복하라 - 몇번인지는 정해지니 않았다. - 이걸 정하고 싶을때 for문을 배우자
	...
	System.out.println("while문 앞에 탈출하면 여기가 출력된다.");
	}

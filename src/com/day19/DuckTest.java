...
// 생성부와 선언부의 이름이 다르면 안된다. - why? 상속관계가 아니잖아. 인터페이스를 implements를 하지 않았자나
public class DuckTest {
	...
	public void methodA(Duck duck) {
		...
		if(duck instanceof RubberDuck) {//너 RubberDuck타입 이니?
			...
			System.out.println("나는 기타 Duck 입니다.");
		}

...
public class Test {
	String exit = "exit";  //public Test() {}// 생략이 가능함 - 단 생성자 하나도 선언된게 없을 때만...
	public void count() {
		...
		while(true) {//365 매일 그리고 계속 실행된다. - 메모리(RAM:휘발성-오라클-Table 구조 : MemberVO)에 계속 쌓인다
			...
			if(str.equals("exit")) {//사용자가 도스창에 exit이라는 문자열을 입력하면. 그래서 같니? equals @abcd1234 == "exit"

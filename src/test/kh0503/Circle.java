package test.kh0503;
// UML도구를 이용해서 클래스 설계 할 때 +:public, -:private, #:protected
class Circle {
	...
	public double radius;//double의 디폴트값은 0.0dlek
	...
	public void setRadius(double radius) { //radius-3.1복사된다. call by value
		this.radius = radius;//파라미터로 복사된 3.1을 전번에 대입하세요
	}

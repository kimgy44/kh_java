...
//컴넌트들의 위치를 정해줍니다.
	...
	// 셋팅하는 메쏘드입니다.
	private void setEditable(boolean e) { // 파라미터 boolean에 따라서 결정,, true이면 일괄 true, false이면 일괄 false
  	...
  	private void btnOkayActionPerformed(ActionEvent evt) {
		...
		if(avo !=null){
			...
			try{
				...
				// vo.send메소드의 파라미터로 넘기는 이유는 뭘까?
				// 버튼을 AddressBook에 있는데.. 처리는 ModifyDialog에서 해야함

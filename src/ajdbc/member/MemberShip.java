...
public class MemberShip extends JFrame implements ActionListener, MouseListener {
	...
	*************************************************************************/                
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == jbtn_zipcode) {//외부에 있는 화면을 뜨우기 위해서 initDisplay를 생성자에 두지말고 따로 별도로 실행해두자 의 원리
			ZipcodeSearch zs = new ZipcodeSearch(this);//멤버십이라는 주소번지를.원본을 넘겨주는것 //현재로써 this안쓰면 널포인트입센션~!
			zs.initDisplay();//콜백함수로써 버튼이 눌러졌을 때 감지가 되면 시스템 내부적으로 호출이 됨
		}
